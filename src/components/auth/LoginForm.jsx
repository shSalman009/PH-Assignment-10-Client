...
import { Eye, EyeOff, ArrowRight, Sparkles, KeyRound } from "lucide-react";
          ...
          <div className="rounded-2xl border bg-background/60 p-6 backdrop-blur-md shadow-xl text-left space-y-4 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Sign in to your RecipeHub account to access your personalized
                dashboard, manage your recipes, and explore a world of culinary
                inspiration. Enjoy a seamless experience with our secure and
